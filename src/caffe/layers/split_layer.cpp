...
void SplitLayer<Dtype,Mtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype, typename Mtype>
void SplitLayer<Dtype,Mtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  for (int i = 0; i < top.size(); ++i) {
...
template <typename Dtype, typename Mtype>
void SplitLayer<Dtype,Mtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
