...
void SoftmaxLayer<Dtype,Mtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype, typename Mtype>
void SoftmaxLayer<Dtype,Mtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype, typename Mtype>
void SoftmaxLayer<Dtype,Mtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
