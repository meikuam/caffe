...
template <typename Dtype, typename Mtype>
void DeconvolutionLayer<Dtype,Mtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype, typename Mtype>
void DeconvolutionLayer<Dtype,Mtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
