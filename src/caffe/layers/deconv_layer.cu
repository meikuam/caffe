...
void DeconvolutionLayer<Dtype,Mtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype, typename Mtype>
void DeconvolutionLayer<Dtype,Mtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
