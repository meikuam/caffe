...
template <typename Dtype, typename Mtype>
void SigmoidLayer<Dtype,Mtype>::Forward_gpu(const vector<Blob<Dtype,Mtype>*>& bottom,
...
template <typename Dtype, typename Mtype>
void SigmoidLayer<Dtype,Mtype>::Backward_gpu(const vector<Blob<Dtype,Mtype>*>& top,
