...
void InnerProductLayer<Dtype,Mtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype, typename Mtype>
void InnerProductLayer<Dtype,Mtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
